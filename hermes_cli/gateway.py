...
_PLATFORMS = [
    ...
    },
    {
        ...
        "setup_instructions": [
            ...
            "2. Copy the Channel Access Token (long-lived) from the channel settings",
            "3. Copy the Channel Secret from the Basic settings tab",
            "4. Set your webhook URL to https://<your-domain>/line/webhook",
            "5. Enable 'Use webhook' in the LINE Developers console",
        ],
        "vars": [
            {"name": "LINE_CHANNEL_ACCESS_TOKEN", "prompt": "Channel Access Token", "password": True,
             "help": "Long-lived channel access token from LINE Developers console (step 2)."},
            {"name": "LINE_CHANNEL_SECRET", "prompt": "Channel Secret", "password": True,
             "help": "Channel secret for webhook signature verification (step 3)."},
            {"name": "LINE_ALLOWED_USERS", "prompt": "Allowed User IDs (comma-separated, e.g. U1234...)", "password": False,
             "is_allowlist": True,
             "help": "LINE user IDs start with 'U'. Find yours via the LINE Developers webhook logs."},
            {"name": "LINE_HOME_CHANNEL", "prompt": "Home channel ID (for cron/notification delivery, or empty to set later)", "password": False,
             "help": "A LINE user ID (U...) or group ID (C...) to use as the default delivery target."},
        ],
    },
    {
        "key": "discord",
